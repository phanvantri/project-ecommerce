...
public class DashBoardController {
    ...
    @GetMapping("/summoneyonemounthdate")
    public List<ChartByMounth> sumMoneyOneMounthDate(@RequestParam("date") String date1) {
    ...
    @GetMapping("/summoneyoneweekdate")
    public List<ChartM> sumMoneyOneWeekDate(@RequestParam("date") String date) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        ZoneId defaultZoneId = ZoneId.systemDefault();
