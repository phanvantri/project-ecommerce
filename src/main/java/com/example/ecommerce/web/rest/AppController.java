...
public class AppController {
    ...
    @GetMapping ("/bank")
    public boolean getbBank(@RequestParam Long idOrder,@CurrentUser UserPrincipal userPrincipal){
    ...
    public ModelQrcode getOrder(){
        Order o1 = orderService.getById((long)15);
